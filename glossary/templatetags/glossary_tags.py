...
# @register.inclusion_tag(takes_context=True, "glossary/_letters_index.htnl")
# def letter_index(context):

#     used_letters = set(Term.objects.distinct().extra(
#         select={'f_letter': "upper(substr(title,1,1))"}).values_list(
#             'f_letter', flat=True))

#     return {"used_letters": used_letters}
